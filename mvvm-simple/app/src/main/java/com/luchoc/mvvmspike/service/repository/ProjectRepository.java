...
// Interacts with the GitHub service and provides a LiveData object for the ViewModel to use
...
public class ProjectRepository {
    ...
    private ProjectRepository() {
        ...
        // this creates the REST client using retrofit
    ...
    // Returns observable list of projects (i.e. consumers can subscribe to this producer to get updates on list of Projects)
    public LiveData<List<Project>> getProjectList(String userId) {
        final MutableLiveData<List<Project>> data = new MutableLiveData<>();

        // make REST call to GitHub API. Takes a callback.
